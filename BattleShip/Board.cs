    ...
    public class Board
    {
        ...
        public void PlaceShip(Ship ship)
        {
            ...
            if (ship.Size == 1)
            {
                ...
                {
                    Console.WriteLine("Nie mozna sutawić tutaj statku bo jest za malo miejsca. Sprobuj ponownie.");
                    PlaceShip(ship);
                    return;
                }
            }
            ...
            {
                Console.WriteLine("Podaj kierunek statku: poziomo( H ) albo pionowo( V ).");
